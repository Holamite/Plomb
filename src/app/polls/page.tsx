          ...
          <div className="p-5">
            ...
            <div className="flex flex-col gap-3 mb-3">
              <div className="flex justify-between">
                <p className="text-neutral-300">Country</p>
                <p className="font-mono">Nigeria</p>
              </div>
              ...
              <div className="flex justify-between">
                <p className="text-neutral-300">Participant Name</p>
                <p className="font-mono">Rampop...</p>
              </div>
            </div>

            {/* <div className="w-1/2 text-sm lg:text-base">
              {getCurrentTime > results?.startTime &&
                getCurrentTime < results?.endTime && (
                  <div className="w-32 xs:w-full flex gap-2 justify-center text-gray-400 p-2 border-[0.5px] border-neutral-700 rounded-3xl">
                    <p className="w-2 h-2 mt-2 bg-green-500 rounded-full"></p>
                    <p>Sales live</p>
                  </div>
                )}
              {getCurrentTime > results?.endTime && (
                <div className="flex gap-2 justify-center text-gray-400 p-2 border-[0.5px] border-neutral-700 rounded-3xl">
                  <p className="w-2 h-2 mt-2 bg-red-500 rounded-full"></p>
                  <p>Failed</p>
                </div>
              )}
              {getCurrentTime > results?.endTime && (
              ...
              {getCurrentTime < results?.startTime && (
                <Countdown targetData={new Date(results?.startTime * 1000)} />
              )}
            </div> */}
            ...
            <div className="flex justify-center items-center gap-4">
              <a
                href="#"
                className="inline-flex items-center text-sm font-medium text-center text-white bg-[#00ACE3] py-2 px-8 rounded-md  hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-300 dark:focus:ring-blue-800"
              >
                View Details
                <svg
              ...
              <Countdown targetData={new Date(100976543 * 1000)} />
            </div>
          </div>
        </div>
      </div>
